...
def test__get_relpath(
    en_us_filetype_lang: FiletypeLang, zh_cn_filetype_lang: FiletypeLang, ja_jp_filetype_lang: FiletypeLang, pt_br_filetype_lang: FiletypeLang
) -> None:
...
def test__get_properties(
    ...
    assert pt_br_filetype_lang.properties == {
        "lang|test": Property("lang|test", "teste", "test=teste", 11, 14),
        "lang|test2": Property("lang|test2", "teste2=teste2", "test2=teste2=teste2", 22, 31),
    }
...
def test_get_zh_cn_relpath(
    ...
    assert pt_br_filetype_lang.get_target_language_relpath(Language.pt_BR) == PT_BR_RELPATH
